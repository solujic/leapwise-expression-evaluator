...
@Component
public class GreaterThanOrEqualExpressionHandler extends ExpressionHandlerAbstract {

  public GreaterThanOrEqualExpressionHandler() {
    super(ExpressionOperator.GREATER_THAN_OR_EQUAL);
  }
  ...
  public boolean supportsExpression(String expression) {
    return expression.contains(ExpressionOperator.GREATER_THAN_OR_EQUAL.getValue());
  }
}
